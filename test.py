...
from testing.db_tests import test_init_db, test_get_inventory_exists, test_dict_factory_link, \
    test_check_connection_threaded, test_stock_filtered, test_product_category
...
DB_FUNCS = [test_init_db, test_get_inventory_exists,
            ...
            test_stock_filtered,test_product_category]
